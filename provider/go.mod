module github.com/rootlyhq/pulumi-rootly/provider

go 1.27.1

// Keep the fork required by pulumi-terraform-bridge v3.139.0.
...
require (
	...
	github.com/opentofu/registry-address/v2 v2.0.0-20260904125703-4be56d5b1d3e // indirect
	github.com/opentofu/svchost v0.0.0-20260410171206-1a42986aa3f4 // indirect
	...
	// Later versions use a module path the bridge does not import.
...
replace github.com/rootlyhq/terraform-provider-rootly/v5/pulumi-shim => ./shim
