...
// Package rootly provides the Pulumi provider configuration for Rootly.
package rootly
...
//go:embed cmd/pulumi-resource-rootly/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-rootly/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-rootly/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "rootly", rootly.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-rootly/provider".New
		...
		LogoURL: "https://raw.githubusercontent.com/rootlyhq/pulumi-rootly/v1.0.0/rootly.svg",
