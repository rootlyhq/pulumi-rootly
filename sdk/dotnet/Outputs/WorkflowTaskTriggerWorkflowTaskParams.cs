...
namespace Pulumi.Rootly.Outputs
{
    ...
    [OutputType]
    public sealed class WorkflowTaskTriggerWorkflowTaskParams
    {
        /// <summary>
        ...
        /// </summary>
        public readonly bool? CheckWorkflowConditions;
        /// <summary>
        ...
        /// Map must contain two fields, `id` and `name`.
        /// </summary>
        public readonly ImmutableDictionary<string, string> Workflow;

        [OutputConstructor]
        private WorkflowTaskTriggerWorkflowTaskParams(
            string attributeToQueryBy,

            bool? checkWorkflowConditions,
            ...
            ImmutableDictionary<string, string> workflow)
        {
            AttributeToQueryBy = attributeToQueryBy;
            CheckWorkflowConditions = checkWorkflowConditions;
            Kind = kind;
            Resource = resource;
            TaskType = taskType;
            Workflow = workflow;
