...
{
    [RootlyResourceType("rootly:index/workflowPostMortem:WorkflowPostMortem")]
    public partial class WorkflowPostMortem : global::Pulumi.CustomResource
    {
        [Output("causeIds")]
        ...
        public Output<Outputs.WorkflowPostMortemTriggerParams> TriggerParams { get; private set; } = null!;
        ...
        public WorkflowPostMortem(string name, WorkflowPostMortemArgs? args = null, CustomResourceOptions? options = null)
            : base("rootly:index/workflowPostMortem:WorkflowPostMortem", name, args ?? new WorkflowPostMortemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkflowPostMortem(string name, Input<string> id, WorkflowPostMortemState? state = null, CustomResourceOptions? options = null)
            : base("rootly:index/workflowPostMortem:WorkflowPostMortem", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WorkflowPostMortem Get(string name, Input<string> id, WorkflowPostMortemState? state = null, CustomResourceOptions? options = null)
        {
            return new WorkflowPostMortem(name, id, state, options);
        }
    }

    public sealed class WorkflowPostMortemArgs : global::Pulumi.ResourceArgs
    {
        [Input("causeIds")]
        ...
        [Input("triggerParams")]
        public Input<Inputs.WorkflowPostMortemTriggerParamsArgs>? TriggerParams { get; set; }
        ...
        public WorkflowPostMortemArgs()
        {
        }
        public static new WorkflowPostMortemArgs Empty => new WorkflowPostMortemArgs();
    }

    public sealed class WorkflowPostMortemState : global::Pulumi.ResourceArgs
    {
        [Input("causeIds")]
        private InputList<string>? _causeIds;
        public InputList<string> CauseIds
        ...
        [Input("triggerParams")]
        public Input<Inputs.WorkflowPostMortemTriggerParamsGetArgs>? TriggerParams { get; set; }
        ...
        public WorkflowPostMortemState()
        {
        }
        public static new WorkflowPostMortemState Empty => new WorkflowPostMortemState();
    }
}
