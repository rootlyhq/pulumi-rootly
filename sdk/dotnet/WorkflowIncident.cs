...
namespace Pulumi.Rootly
{
    ...
    /// ## Example Usage
    /// </summary>
    [RootlyResourceType("rootly:index/workflowIncident:WorkflowIncident")]
    public partial class WorkflowIncident : global::Pulumi.CustomResource
    {
        [Output("causeIds")]
        ...
        public Output<Outputs.WorkflowIncidentTriggerParams> TriggerParams { get; private set; } = null!;
        ...
        public WorkflowIncident(string name, WorkflowIncidentArgs? args = null, CustomResourceOptions? options = null)
            : base("rootly:index/workflowIncident:WorkflowIncident", name, args ?? new WorkflowIncidentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkflowIncident(string name, Input<string> id, WorkflowIncidentState? state = null, CustomResourceOptions? options = null)
            : base("rootly:index/workflowIncident:WorkflowIncident", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WorkflowIncident Get(string name, Input<string> id, WorkflowIncidentState? state = null, CustomResourceOptions? options = null)
        {
            return new WorkflowIncident(name, id, state, options);
        }
    }

    public sealed class WorkflowIncidentArgs : global::Pulumi.ResourceArgs
    {
        [Input("causeIds")]
        ...
        [Input("triggerParams")]
        public Input<Inputs.WorkflowIncidentTriggerParamsArgs>? TriggerParams { get; set; }
        ...
        public WorkflowIncidentArgs()
        {
        }
        public static new WorkflowIncidentArgs Empty => new WorkflowIncidentArgs();
    }

    public sealed class WorkflowIncidentState : global::Pulumi.ResourceArgs
    {
        [Input("causeIds")]
        private InputList<string>? _causeIds;
        public InputList<string> CauseIds
        ...
        [Input("triggerParams")]
        public Input<Inputs.WorkflowIncidentTriggerParamsGetArgs>? TriggerParams { get; set; }
        ...
        public WorkflowIncidentState()
        {
        }
        public static new WorkflowIncidentState Empty => new WorkflowIncidentState();
    }
}
