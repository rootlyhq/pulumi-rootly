...
namespace Pulumi.Rootly
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Rootly.version.txt");
    ...
    internal sealed class RootlyResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public RootlyResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
