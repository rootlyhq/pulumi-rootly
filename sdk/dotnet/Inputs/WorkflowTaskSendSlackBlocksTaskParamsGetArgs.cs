...
namespace Pulumi.Rootly.Inputs
{
    ...
    public sealed class WorkflowTaskSendSlackBlocksTaskParamsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("channels")]
        private InputList<Inputs.WorkflowTaskSendSlackBlocksTaskParamsChannelGetArgs>? _channels;
        public InputList<Inputs.WorkflowTaskSendSlackBlocksTaskParamsChannelGetArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WorkflowTaskSendSlackBlocksTaskParamsChannelGetArgs>());
            set => _channels = value;
        }
        ...
        private InputList<Inputs.WorkflowTaskSendSlackBlocksTaskParamsSlackUserGroupGetArgs>? _slackUserGroups;
        public InputList<Inputs.WorkflowTaskSendSlackBlocksTaskParamsSlackUserGroupGetArgs> SlackUserGroups
        {
            get => _slackUserGroups ?? (_slackUserGroups = new InputList<Inputs.WorkflowTaskSendSlackBlocksTaskParamsSlackUserGroupGetArgs>());
            set => _slackUserGroups = value;
        }

        [Input("slackUsers")]
        private InputList<Inputs.WorkflowTaskSendSlackBlocksTaskParamsSlackUserGetArgs>? _slackUsers;
        public InputList<Inputs.WorkflowTaskSendSlackBlocksTaskParamsSlackUserGetArgs> SlackUsers
        {
            get => _slackUsers ?? (_slackUsers = new InputList<Inputs.WorkflowTaskSendSlackBlocksTaskParamsSlackUserGetArgs>());
        ...
        public WorkflowTaskSendSlackBlocksTaskParamsGetArgs()
        {
        }
        public static new WorkflowTaskSendSlackBlocksTaskParamsGetArgs Empty => new WorkflowTaskSendSlackBlocksTaskParamsGetArgs();
    }
}
