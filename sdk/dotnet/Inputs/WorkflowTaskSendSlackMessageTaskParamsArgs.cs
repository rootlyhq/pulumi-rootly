...
namespace Pulumi.Rootly.Inputs
{
    ...
    public sealed class WorkflowTaskSendSlackMessageTaskParamsArgs : global::Pulumi.ResourceArgs
    {
        [Input("actionables")]
        ...
        [Input("channels")]
        private InputList<Inputs.WorkflowTaskSendSlackMessageTaskParamsChannelArgs>? _channels;
        public InputList<Inputs.WorkflowTaskSendSlackMessageTaskParamsChannelArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WorkflowTaskSendSlackMessageTaskParamsChannelArgs>());
            set => _channels = value;
        }
        ...
        private InputList<Inputs.WorkflowTaskSendSlackMessageTaskParamsSlackUserGroupArgs>? _slackUserGroups;
        public InputList<Inputs.WorkflowTaskSendSlackMessageTaskParamsSlackUserGroupArgs> SlackUserGroups
        {
            get => _slackUserGroups ?? (_slackUserGroups = new InputList<Inputs.WorkflowTaskSendSlackMessageTaskParamsSlackUserGroupArgs>());
            set => _slackUserGroups = value;
        }

        [Input("slackUsers")]
        private InputList<Inputs.WorkflowTaskSendSlackMessageTaskParamsSlackUserArgs>? _slackUsers;
        public InputList<Inputs.WorkflowTaskSendSlackMessageTaskParamsSlackUserArgs> SlackUsers
        {
            get => _slackUsers ?? (_slackUsers = new InputList<Inputs.WorkflowTaskSendSlackMessageTaskParamsSlackUserArgs>());
        ...
        public WorkflowTaskSendSlackMessageTaskParamsArgs()
        {
        }
        public static new WorkflowTaskSendSlackMessageTaskParamsArgs Empty => new WorkflowTaskSendSlackMessageTaskParamsArgs();
    }
}
