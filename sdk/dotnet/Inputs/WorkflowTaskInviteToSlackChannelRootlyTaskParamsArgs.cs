...
namespace Pulumi.Rootly.Inputs
{
    ...
    public sealed class WorkflowTaskInviteToSlackChannelRootlyTaskParamsArgs : global::Pulumi.ResourceArgs
    {
        [Input("channels")]
        private InputList<Inputs.WorkflowTaskInviteToSlackChannelRootlyTaskParamsChannelArgs>? _channels;
        public InputList<Inputs.WorkflowTaskInviteToSlackChannelRootlyTaskParamsChannelArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WorkflowTaskInviteToSlackChannelRootlyTaskParamsChannelArgs>());
            set => _channels = value;
        }
        ...
        public WorkflowTaskInviteToSlackChannelRootlyTaskParamsArgs()
        {
        }
        public static new WorkflowTaskInviteToSlackChannelRootlyTaskParamsArgs Empty => new WorkflowTaskInviteToSlackChannelRootlyTaskParamsArgs();
    }
}
