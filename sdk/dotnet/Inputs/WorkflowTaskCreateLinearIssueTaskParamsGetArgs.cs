...
namespace Pulumi.Rootly.Inputs
{
    ...
    public sealed class WorkflowTaskCreateLinearIssueTaskParamsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("labels")]
        private InputList<Inputs.WorkflowTaskCreateLinearIssueTaskParamsLabelGetArgs>? _labels;
        public InputList<Inputs.WorkflowTaskCreateLinearIssueTaskParamsLabelGetArgs> Labels
        {
            get => _labels ?? (_labels = new InputList<Inputs.WorkflowTaskCreateLinearIssueTaskParamsLabelGetArgs>());
            set => _labels = value;
        }
        ...
        public WorkflowTaskCreateLinearIssueTaskParamsGetArgs()
        {
        }
        public static new WorkflowTaskCreateLinearIssueTaskParamsGetArgs Empty => new WorkflowTaskCreateLinearIssueTaskParamsGetArgs();
    }
}
