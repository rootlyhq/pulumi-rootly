...
namespace Pulumi.Rootly.Inputs
{
    ...
    public sealed class WorkflowTaskInviteToSlackChannelRootlyTaskParamsGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("channels")]
        private InputList<Inputs.WorkflowTaskInviteToSlackChannelRootlyTaskParamsChannelGetArgs>? _channels;
        public InputList<Inputs.WorkflowTaskInviteToSlackChannelRootlyTaskParamsChannelGetArgs> Channels
        {
            get => _channels ?? (_channels = new InputList<Inputs.WorkflowTaskInviteToSlackChannelRootlyTaskParamsChannelGetArgs>());
            set => _channels = value;
        }
        ...
        public WorkflowTaskInviteToSlackChannelRootlyTaskParamsGetArgs()
        {
        }
        public static new WorkflowTaskInviteToSlackChannelRootlyTaskParamsGetArgs Empty => new WorkflowTaskInviteToSlackChannelRootlyTaskParamsGetArgs();
    }
}
