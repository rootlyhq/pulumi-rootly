...
namespace Pulumi.Rootly.Inputs
{
    ...
    public sealed class WorkflowTaskCreateAsanaSubtaskTaskParamsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// The parent task id
        /// </summary>
        [Input("parentTaskId", required: true)]
        public Input<string> ParentTaskId { get; set; } = null!;
        ...
        public WorkflowTaskCreateAsanaSubtaskTaskParamsGetArgs()
        {
        }
        public static new WorkflowTaskCreateAsanaSubtaskTaskParamsGetArgs Empty => new WorkflowTaskCreateAsanaSubtaskTaskParamsGetArgs();
    }
}
