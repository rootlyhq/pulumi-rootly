...
namespace Pulumi.Rootly.Inputs
{
    ...
    public sealed class WorkflowTaskCreateJiraSubtaskTaskParamsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("subtaskIssueType", required: true)]
        private InputMap<string>? _subtaskIssueType;

        /// <summary>
        /// Map must contain two fields, `id` and `name`. The issue type id and display name
        /// </summary>
        public InputMap<string> SubtaskIssueType
        {
            get => _subtaskIssueType ?? (_subtaskIssueType = new InputMap<string>());
            set => _subtaskIssueType = value;
        }
        ...
        public WorkflowTaskCreateJiraSubtaskTaskParamsGetArgs()
        {
        }
        public static new WorkflowTaskCreateJiraSubtaskTaskParamsGetArgs Empty => new WorkflowTaskCreateJiraSubtaskTaskParamsGetArgs();
    }
}
