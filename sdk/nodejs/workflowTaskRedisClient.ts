 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskRedisClient using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskRedisClient:WorkflowTaskRedisClient my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskRedisClient extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskRedisClientTaskParams>;
    /**
...
export interface WorkflowTaskRedisClientState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskRedisClientTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
