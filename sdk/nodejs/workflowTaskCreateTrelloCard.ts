 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskCreateTrelloCard using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskCreateTrelloCard:WorkflowTaskCreateTrelloCard my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskCreateTrelloCard extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskCreateTrelloCardTaskParams>;
    /**
...
export interface WorkflowTaskCreateTrelloCardState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskCreateTrelloCardTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
