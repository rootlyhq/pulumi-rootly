 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskCreateQuipPage using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskCreateQuipPage:WorkflowTaskCreateQuipPage my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskCreateQuipPage extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskCreateQuipPageTaskParams>;
    /**
...
export interface WorkflowTaskCreateQuipPageState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskCreateQuipPageTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
