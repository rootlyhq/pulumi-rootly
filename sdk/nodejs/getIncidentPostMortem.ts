 ...
 * ## Example Usage
 */
export function getIncidentPostMortemOutput(args?: GetIncidentPostMortemOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIncidentPostMortemResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("rootly:index/getIncidentPostMortem:getIncidentPostMortem", {
        "createdAt": args.createdAt,
        "mitigatedAt": args.mitigatedAt,
        "resolvedAt": args.resolvedAt,
        "startedAt": args.startedAt,
