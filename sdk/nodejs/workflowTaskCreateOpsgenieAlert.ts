 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskCreateOpsgenieAlert using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskCreateOpsgenieAlert:WorkflowTaskCreateOpsgenieAlert my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskCreateOpsgenieAlert extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskCreateOpsgenieAlertTaskParams>;
    /**
...
export interface WorkflowTaskCreateOpsgenieAlertState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskCreateOpsgenieAlertTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
