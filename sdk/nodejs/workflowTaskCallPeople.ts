 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskCallPeople using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskCallPeople:WorkflowTaskCallPeople my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskCallPeople extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskCallPeopleTaskParams>;
    /**
...
export interface WorkflowTaskCallPeopleState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskCallPeopleTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
