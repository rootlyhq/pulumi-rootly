 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskUpdateSlackChannelTopic using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskUpdateSlackChannelTopic:WorkflowTaskUpdateSlackChannelTopic my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskUpdateSlackChannelTopic extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskUpdateSlackChannelTopicTaskParams>;
    /**
...
export interface WorkflowTaskUpdateSlackChannelTopicState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskUpdateSlackChannelTopicTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
