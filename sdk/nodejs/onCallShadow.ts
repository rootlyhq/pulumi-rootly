 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.OnCallShadow using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/onCallShadow:OnCallShadow my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class OnCallShadow extends pulumi.CustomResource {
     ...
     */
    declare public readonly shadowUserId: pulumi.Output<number>;
    /**
     * ID of schedule or user the shadow user is shadowing
     */
    declare public readonly shadowableId: pulumi.Output<string>;
    /**
     * Value must be one of `User`, `Schedule`.
     */
    declare public readonly shadowableType: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: OnCallShadowArgs | OnCallShadowState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["shadowUserId"] = state?.shadowUserId;
            resourceInputs["shadowableId"] = state?.shadowableId;
            resourceInputs["shadowableType"] = state?.shadowableType;
            ...
            if (args?.shadowableId === undefined && !opts.urn) {
            ...
            resourceInputs["shadowUserId"] = args?.shadowUserId;
            resourceInputs["shadowableId"] = args?.shadowableId;
            resourceInputs["shadowableType"] = args?.shadowableType;
