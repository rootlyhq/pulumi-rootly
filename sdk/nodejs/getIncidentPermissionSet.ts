...
export function getIncidentPermissionSetOutput(args?: GetIncidentPermissionSetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIncidentPermissionSetResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("rootly:index/getIncidentPermissionSet:getIncidentPermissionSet", {
        "createdAt": args.createdAt,
        "name": args.name,
        "slug": args.slug,
    }, opts);
