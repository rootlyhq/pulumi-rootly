...
export class WorkflowPostMortem extends pulumi.CustomResource {
     ...
     */
    declare public readonly failureNotificationChannels: pulumi.Output<outputs.WorkflowPostMortemFailureNotificationChannel[]>;
    /**
    ...
    declare public readonly triggerParams: pulumi.Output<outputs.WorkflowPostMortemTriggerParams>;
    /**
...
export interface WorkflowPostMortemState {
     ...
     * Slack channels notified when a run of this workflow fails. Used when `failureNotificationMode` is `custom`.
     */
    failureNotificationChannels?: pulumi.Input<pulumi.Input<inputs.WorkflowPostMortemFailureNotificationChannel>[] | undefined>;
    /**
     * Where failure notifications for this workflow are sent. `inherit` uses the account default channel, `custom` uses `failureNotificationChannels`, `off` suppresses them. Value must be one of `inherit`, `custom`, `off`.
     */
    ...
    triggerParams?: pulumi.Input<inputs.WorkflowPostMortemTriggerParams | undefined>;
    /**
     * Wait this duration before executing
     */
