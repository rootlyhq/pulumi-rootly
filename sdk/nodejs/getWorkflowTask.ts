 ...
 * ## Example Usage
 */
export function getWorkflowTaskOutput(args: GetWorkflowTaskOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkflowTaskResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("rootly:index/getWorkflowTask:getWorkflowTask", {
        "name": args.name,
        "slug": args.slug,
        "workflowId": args.workflowId,
    }, opts);
