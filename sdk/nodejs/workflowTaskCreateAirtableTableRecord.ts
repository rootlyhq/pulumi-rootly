 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskCreateAirtableTableRecord using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskCreateAirtableTableRecord:WorkflowTaskCreateAirtableTableRecord my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskCreateAirtableTableRecord extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskCreateAirtableTableRecordTaskParams>;
    /**
...
export interface WorkflowTaskCreateAirtableTableRecordState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskCreateAirtableTableRecordTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
