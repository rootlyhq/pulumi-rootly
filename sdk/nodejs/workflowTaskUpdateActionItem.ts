 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskUpdateActionItem using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskUpdateActionItem:WorkflowTaskUpdateActionItem my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskUpdateActionItem extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskUpdateActionItemTaskParams>;
    /**
...
export interface WorkflowTaskUpdateActionItemState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskUpdateActionItemTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
