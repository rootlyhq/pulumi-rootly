 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskUpdateJiraIssue using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskUpdateJiraIssue:WorkflowTaskUpdateJiraIssue my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskUpdateJiraIssue extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskUpdateJiraIssueTaskParams>;
    /**
...
export interface WorkflowTaskUpdateJiraIssueState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskUpdateJiraIssueTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
