...
export function getFunctionalitiesOutput(args?: GetFunctionalitiesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFunctionalitiesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("rootly:index/getFunctionalities:getFunctionalities", {
        "name": args.name,
        "opsgenieId": args.opsgenieId,
        "pagerdutyId": args.pagerdutyId,
        "slug": args.slug,
