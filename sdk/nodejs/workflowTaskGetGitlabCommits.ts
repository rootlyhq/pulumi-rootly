 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskGetGitlabCommits using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskGetGitlabCommits:WorkflowTaskGetGitlabCommits my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskGetGitlabCommits extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskGetGitlabCommitsTaskParams>;
    /**
...
export interface WorkflowTaskGetGitlabCommitsState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskGetGitlabCommitsTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
