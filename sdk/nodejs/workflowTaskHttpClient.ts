 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskHttpClient using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskHttpClient:WorkflowTaskHttpClient my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskHttpClient extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskHttpClientTaskParams>;
    /**
...
export interface WorkflowTaskHttpClientState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskHttpClientTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
