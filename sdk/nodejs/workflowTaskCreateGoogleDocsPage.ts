 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskCreateGoogleDocsPage using the `id`. For example:
 *
 * ```sh
...
export class WorkflowTaskCreateGoogleDocsPage extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskCreateGoogleDocsPageTaskParams>;
    /**
...
export interface WorkflowTaskCreateGoogleDocsPageState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskCreateGoogleDocsPageTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
