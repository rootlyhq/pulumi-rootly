 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskUpdateServiceNowIncident using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskUpdateServiceNowIncident:WorkflowTaskUpdateServiceNowIncident my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskUpdateServiceNowIncident extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskUpdateServiceNowIncidentTaskParams>;
    /**
...
export interface WorkflowTaskUpdateServiceNowIncidentState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskUpdateServiceNowIncidentTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
