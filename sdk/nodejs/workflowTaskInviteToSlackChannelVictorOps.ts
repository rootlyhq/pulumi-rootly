 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskInviteToSlackChannelVictorOps using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskInviteToSlackChannelVictorOps:WorkflowTaskInviteToSlackChannelVictorOps my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskInviteToSlackChannelVictorOps extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskInviteToSlackChannelVictorOpsTaskParams>;
    /**
...
export interface WorkflowTaskInviteToSlackChannelVictorOpsState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskInviteToSlackChannelVictorOpsTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
