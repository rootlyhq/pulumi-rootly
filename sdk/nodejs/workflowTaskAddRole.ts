 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskAddRole using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskAddRole:WorkflowTaskAddRole my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskAddRole extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskAddRoleTaskParams>;
    /**
...
export interface WorkflowTaskAddRoleState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskAddRoleTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
