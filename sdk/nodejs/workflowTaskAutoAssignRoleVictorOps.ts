 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskAutoAssignRoleVictorOps using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskAutoAssignRoleVictorOps:WorkflowTaskAutoAssignRoleVictorOps my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskAutoAssignRoleVictorOps extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskAutoAssignRoleVictorOpsTaskParams>;
    /**
...
export interface WorkflowTaskAutoAssignRoleVictorOpsState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskAutoAssignRoleVictorOpsTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
