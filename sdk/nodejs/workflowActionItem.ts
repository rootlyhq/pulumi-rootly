 ...
 * ## Import
 *
 * rootly.WorkflowActionItem can be imported using the `import` command.
 *
 * ```sh
 ...
 * ```
 */
export class WorkflowActionItem extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkflowActionItemState, opts?: pulumi.CustomResourceOptions): WorkflowActionItem {
        return new WorkflowActionItem(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'rootly:index/workflowActionItem:WorkflowActionItem';

    /**
     * Returns true if the given object is an instance of WorkflowActionItem.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WorkflowActionItem {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WorkflowActionItem.__pulumiType;
    }
     ...
     */
    declare public readonly failureNotificationChannels: pulumi.Output<outputs.WorkflowActionItemFailureNotificationChannel[]>;
    /**
    ...
    declare public readonly triggerParams: pulumi.Output<outputs.WorkflowActionItemTriggerParams>;
    /**
    ...
    /**
     * Create a WorkflowActionItem resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: WorkflowActionItemArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WorkflowActionItemArgs | WorkflowActionItemState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WorkflowActionItemState | undefined;
            ...
            const args = argsOrState as WorkflowActionItemArgs | undefined;
        ...
        super(WorkflowActionItem.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface WorkflowActionItemState {
     ...
     * Slack channels notified when a run of this workflow fails. Used when `failureNotificationMode` is `custom`.
     */
    failureNotificationChannels?: pulumi.Input<pulumi.Input<inputs.WorkflowActionItemFailureNotificationChannel>[] | undefined>;
    /**
     * Where failure notifications for this workflow are sent. `inherit` uses the account default channel, `custom` uses `failureNotificationChannels`, `off` suppresses them. Value must be one of `inherit`, `custom`, `off`.
     */
    ...
    triggerParams?: pulumi.Input<inputs.WorkflowActionItemTriggerParams | undefined>;
    /**
     * Wait this duration before executing
     */
 ...
 */
export interface WorkflowActionItemArgs {
    causeIds?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * Workflow command
     */
