...
export function getCausesOutput(args?: GetCausesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCausesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("rootly:index/getCauses:getCauses", {
        "name": args.name,
        "slug": args.slug,
    }, opts);
}
