 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskRemoveGoogleDocsPermissions using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskRemoveGoogleDocsPermissions:WorkflowTaskRemoveGoogleDocsPermissions my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskRemoveGoogleDocsPermissions extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskRemoveGoogleDocsPermissionsTaskParams>;
    /**
...
export interface WorkflowTaskRemoveGoogleDocsPermissionsState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskRemoveGoogleDocsPermissionsTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
