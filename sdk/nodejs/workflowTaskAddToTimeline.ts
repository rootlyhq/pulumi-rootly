 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskAddToTimeline using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskAddToTimeline:WorkflowTaskAddToTimeline my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskAddToTimeline extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskAddToTimelineTaskParams>;
    /**
...
export interface WorkflowTaskAddToTimelineState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskAddToTimelineTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
