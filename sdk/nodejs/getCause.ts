 ...
 * ## Example Usage
 */
export function getCauseOutput(args?: GetCauseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCauseResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("rootly:index/getCause:getCause", {
        "createdAt": args.createdAt,
        "name": args.name,
        "slug": args.slug,
    }, opts);
