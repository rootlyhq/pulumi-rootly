 ...
 * ```
 */
export class WorkflowActionItemFormFieldCondition extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkflowActionItemFormFieldConditionState, opts?: pulumi.CustomResourceOptions): WorkflowActionItemFormFieldCondition {
        return new WorkflowActionItemFormFieldCondition(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'rootly:index/workflowActionItemFormFieldCondition:WorkflowActionItemFormFieldCondition';

    /**
     * Returns true if the given object is an instance of WorkflowActionItemFormFieldCondition.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WorkflowActionItemFormFieldCondition {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WorkflowActionItemFormFieldCondition.__pulumiType;
    }

    /**
     * The trigger condition. Value must be one of `IS`, `IS NOT`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
     */
    declare public readonly actionItemCondition: pulumi.Output<string | undefined>;
    /**
    ...
    /**
     * Create a WorkflowActionItemFormFieldCondition resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WorkflowActionItemFormFieldConditionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WorkflowActionItemFormFieldConditionArgs | WorkflowActionItemFormFieldConditionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WorkflowActionItemFormFieldConditionState | undefined;
            resourceInputs["actionItemCondition"] = state?.actionItemCondition;
            ...
            const args = argsOrState as WorkflowActionItemFormFieldConditionArgs | undefined;
            ...
            resourceInputs["actionItemCondition"] = args?.actionItemCondition;
        ...
        super(WorkflowActionItemFormFieldCondition.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface WorkflowActionItemFormFieldConditionState {
    /**
     * The trigger condition. Value must be one of `IS`, `IS NOT`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
     */
 ...
 */
export interface WorkflowActionItemFormFieldConditionArgs {
    /**
     * The trigger condition. Value must be one of `IS`, `IS NOT`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
     */
    actionItemCondition?: pulumi.Input<string | undefined>;
