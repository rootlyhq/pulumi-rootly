 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskCreatePagerdutyStatusUpdate using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskCreatePagerdutyStatusUpdate:WorkflowTaskCreatePagerdutyStatusUpdate my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskCreatePagerdutyStatusUpdate extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskCreatePagerdutyStatusUpdateTaskParams>;
    /**
...
export interface WorkflowTaskCreatePagerdutyStatusUpdateState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskCreatePagerdutyStatusUpdateTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
