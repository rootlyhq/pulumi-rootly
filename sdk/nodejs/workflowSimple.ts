 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowSimple using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowSimple:WorkflowSimple my-resource my-resource-slug
 * ```
 */
