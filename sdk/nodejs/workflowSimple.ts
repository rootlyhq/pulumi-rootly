...
export class WorkflowSimple extends pulumi.CustomResource {
     ...
     */
    declare public readonly failureNotificationChannels: pulumi.Output<outputs.WorkflowSimpleFailureNotificationChannel[]>;
    /**
    ...
    declare public readonly triggerParams: pulumi.Output<outputs.WorkflowSimpleTriggerParams>;
    /**
...
export interface WorkflowSimpleState {
     ...
     * Slack channels notified when a run of this workflow fails. Used when `failureNotificationMode` is `custom`.
     */
    failureNotificationChannels?: pulumi.Input<pulumi.Input<inputs.WorkflowSimpleFailureNotificationChannel>[] | undefined>;
    /**
     * Where failure notifications for this workflow are sent. `inherit` uses the account default channel, `custom` uses `failureNotificationChannels`, `off` suppresses them. Value must be one of `inherit`, `custom`, `off`.
     */
