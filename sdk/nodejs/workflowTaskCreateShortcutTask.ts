 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskCreateShortcutTask using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskCreateShortcutTask:WorkflowTaskCreateShortcutTask my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskCreateShortcutTask extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskCreateShortcutTaskTaskParams>;
    /**
...
export interface WorkflowTaskCreateShortcutTaskState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskCreateShortcutTaskTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
