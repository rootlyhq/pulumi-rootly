...
export function getIncidentTypesOutput(args?: GetIncidentTypesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIncidentTypesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("rootly:index/getIncidentTypes:getIncidentTypes", {
        "name": args.name,
        "slug": args.slug,
    }, opts);
}
