 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowIncident using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowIncident:WorkflowIncident my-resource my-resource-slug
 * ```
 */
