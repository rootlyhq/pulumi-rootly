 ...
 * ## Import
 *
 * rootly.WorkflowIncident can be imported using the `import` command.
 *
 * ```sh
 ...
 * ```
 */
export class WorkflowIncident extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkflowIncidentState, opts?: pulumi.CustomResourceOptions): WorkflowIncident {
        return new WorkflowIncident(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'rootly:index/workflowIncident:WorkflowIncident';

    /**
     * Returns true if the given object is an instance of WorkflowIncident.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WorkflowIncident {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WorkflowIncident.__pulumiType;
    }
     ...
     */
    declare public readonly failureNotificationChannels: pulumi.Output<outputs.WorkflowIncidentFailureNotificationChannel[]>;
    /**
    ...
    declare public readonly triggerParams: pulumi.Output<outputs.WorkflowIncidentTriggerParams>;
    /**
    ...
    /**
     * Create a WorkflowIncident resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: WorkflowIncidentArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WorkflowIncidentArgs | WorkflowIncidentState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WorkflowIncidentState | undefined;
            ...
            const args = argsOrState as WorkflowIncidentArgs | undefined;
        ...
        super(WorkflowIncident.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface WorkflowIncidentState {
     ...
     * Slack channels notified when a run of this workflow fails. Used when `failureNotificationMode` is `custom`.
     */
    failureNotificationChannels?: pulumi.Input<pulumi.Input<inputs.WorkflowIncidentFailureNotificationChannel>[] | undefined>;
    /**
     * Where failure notifications for this workflow are sent. `inherit` uses the account default channel, `custom` uses `failureNotificationChannels`, `off` suppresses them. Value must be one of `inherit`, `custom`, `off`.
     */
    ...
    triggerParams?: pulumi.Input<inputs.WorkflowIncidentTriggerParams | undefined>;
    /**
     * Wait this duration before executing
     */
 ...
 */
export interface WorkflowIncidentArgs {
    causeIds?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * Workflow command
     */
