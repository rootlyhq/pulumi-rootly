 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskPageOpsgenieOnCallResponders using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskPageOpsgenieOnCallResponders:WorkflowTaskPageOpsgenieOnCallResponders my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskPageOpsgenieOnCallResponders extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskPageOpsgenieOnCallRespondersTaskParams>;
    /**
...
export interface WorkflowTaskPageOpsgenieOnCallRespondersState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskPageOpsgenieOnCallRespondersTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
