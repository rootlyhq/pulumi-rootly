...
export class EscalationPath extends pulumi.CustomResource {
     ...
     */
    declare public readonly afterDeferralBehavior: pulumi.Output<string>;
    /**
     * The escalation path to execute after this deferral path when after*deferral*behavior is execute_path.
     */
    declare public readonly afterDeferralPathId: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly rules: pulumi.Output<outputs.EscalationPathRule[] | undefined>;
    /**
     ...
     */
    declare public readonly timeRestrictions: pulumi.Output<outputs.EscalationPathTimeRestriction[] | undefined>;
    ...
    constructor(name: string, argsOrState?: EscalationPathArgs | EscalationPathState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["afterDeferralBehavior"] = state?.afterDeferralBehavior;
            resourceInputs["afterDeferralPathId"] = state?.afterDeferralPathId;
            ...
            resourceInputs["afterDeferralBehavior"] = args?.afterDeferralBehavior;
            resourceInputs["afterDeferralPathId"] = args?.afterDeferralPathId;
