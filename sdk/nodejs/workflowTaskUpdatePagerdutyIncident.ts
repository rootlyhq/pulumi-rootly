 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.WorkflowTaskUpdatePagerdutyIncident using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/workflowTaskUpdatePagerdutyIncident:WorkflowTaskUpdatePagerdutyIncident my-resource 00000000-0000-0000-0000-000000000000
 * ```
 */
export class WorkflowTaskUpdatePagerdutyIncident extends pulumi.CustomResource {
     ...
     */
    declare public readonly taskParams: pulumi.Output<outputs.WorkflowTaskUpdatePagerdutyIncidentTaskParams>;
    /**
...
export interface WorkflowTaskUpdatePagerdutyIncidentState {
     ...
     * The parameters for this workflow task.
     */
    taskParams?: pulumi.Input<inputs.WorkflowTaskUpdatePagerdutyIncidentTaskParams | undefined>;
    /**
     * The ID of the parent workflow
     */
