 ...
 * ## Import
 *
 * Using `pulumi import`, import rootly.IncidentPermissionSet using the `id`. For example:
 *
 * ```sh
 * $ pulumi import rootly:index/incidentPermissionSet:IncidentPermissionSet my-resource my-resource-slug
 * ```
 */
export class IncidentPermissionSet extends pulumi.CustomResource {
     ...
     */
    declare public readonly privateIncidentPermissions: pulumi.Output<string[]>;
    /**
     * Value must be one of `create`, `read`, `update`, `delete`.
     */
    ...
    constructor(name: string, argsOrState?: IncidentPermissionSetArgs | IncidentPermissionSetState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["privateIncidentPermissions"] = state?.privateIncidentPermissions;
            resourceInputs["publicIncidentPermissions"] = state?.publicIncidentPermissions;
