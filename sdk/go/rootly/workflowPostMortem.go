...
type WorkflowPostMortem struct {
	...
	FailureNotificationChannels WorkflowPostMortemFailureNotificationChannelArrayOutput `pulumi:"failureNotificationChannels"`
...
type workflowPostMortemState struct {
	...
	// Slack channels notified when a run of this workflow fails. Used when `failureNotificationMode` is `custom`.
	FailureNotificationChannels []WorkflowPostMortemFailureNotificationChannel `pulumi:"failureNotificationChannels"`
	// Where failure notifications for this workflow are sent. `inherit` uses the account default channel, `custom` uses `failureNotificationChannels`, `off` suppresses them. Value must be one of `inherit`, `custom`, `off`.
...
type WorkflowPostMortemState struct {
	...
	// Slack channels notified when a run of this workflow fails. Used when `failureNotificationMode` is `custom`.
	FailureNotificationChannels WorkflowPostMortemFailureNotificationChannelArrayInput
	// Where failure notifications for this workflow are sent. `inherit` uses the account default channel, `custom` uses `failureNotificationChannels`, `off` suppresses them. Value must be one of `inherit`, `custom`, `off`.
...
// When continuously repeat is true, repeat workflows aren't automatically stopped when conditions aren't met. This setting won't override your conditions set by repeat*condition*duration*since*first*run and repeat*condition*number*of_repeats parameters. Value must be one of true or false
func (o WorkflowPostMortemOutput) ContinuouslyRepeat() pulumi.BoolOutput {
	return o.ApplyT(func(v *WorkflowPostMortem) pulumi.BoolOutput { return v.ContinuouslyRepeat }).(pulumi.BoolOutput)
}
...
// Slack channels notified when a run of this workflow fails. Used when `failureNotificationMode` is `custom`.
func (o WorkflowPostMortemOutput) FailureNotificationChannels() WorkflowPostMortemFailureNotificationChannelArrayOutput {
	return o.ApplyT(func(v *WorkflowPostMortem) WorkflowPostMortemFailureNotificationChannelArrayOutput {
		return v.FailureNotificationChannels
	}).(WorkflowPostMortemFailureNotificationChannelArrayOutput)
}

// Where failure notifications for this workflow are sent. `inherit` uses the account default channel, `custom` uses `failureNotificationChannels`, `off` suppresses them. Value must be one of `inherit`, `custom`, `off`.
func (o WorkflowPostMortemOutput) FailureNotificationMode() pulumi.StringOutput {
	return o.ApplyT(func(v *WorkflowPostMortem) pulumi.StringOutput { return v.FailureNotificationMode }).(pulumi.StringOutput)
}
...
// The workflow will stop repeating if its runtime since it's first workflow run exceeds the duration set in this field
func (o WorkflowPostMortemOutput) RepeatConditionDurationSinceFirstRun() pulumi.StringOutput {
	return o.ApplyT(func(v *WorkflowPostMortem) pulumi.StringOutput { return v.RepeatConditionDurationSinceFirstRun }).(pulumi.StringOutput)
}

// The workflow will stop repeating if the number of repeats exceeds the value set in this field
func (o WorkflowPostMortemOutput) RepeatConditionNumberOfRepeats() pulumi.IntOutput {
	return o.ApplyT(func(v *WorkflowPostMortem) pulumi.IntOutput { return v.RepeatConditionNumberOfRepeats }).(pulumi.IntOutput)
}
...
func (o WorkflowPostMortemOutput) SubStatusIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *WorkflowPostMortem) pulumi.StringArrayOutput { return v.SubStatusIds }).(pulumi.StringArrayOutput)
}
