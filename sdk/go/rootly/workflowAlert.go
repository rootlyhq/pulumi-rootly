...
// ## Import
//
// Using `pulumi import`, import WorkflowAlert using the `id`. For example:
//
// ```sh
...
// When continuously repeat is true, repeat workflows aren't automatically stopped when conditions aren't met. This setting won't override your conditions set by repeat*condition*duration*since*first*run and repeat*condition*number*of_repeats parameters.. Value must be one of true or false
func (o WorkflowAlertOutput) ContinuouslyRepeat() pulumi.BoolOutput {
	return o.ApplyT(func(v *WorkflowAlert) pulumi.BoolOutput { return v.ContinuouslyRepeat }).(pulumi.BoolOutput)
}
...
// The workflow will stop repeating if its runtime since it's first workflow run exceeds the duration set in this field
func (o WorkflowAlertOutput) RepeatConditionDurationSinceFirstRun() pulumi.StringOutput {
	return o.ApplyT(func(v *WorkflowAlert) pulumi.StringOutput { return v.RepeatConditionDurationSinceFirstRun }).(pulumi.StringOutput)
}

// The workflow will stop repeating if the number of repeats exceeds the value set in this field
func (o WorkflowAlertOutput) RepeatConditionNumberOfRepeats() pulumi.IntOutput {
	return o.ApplyT(func(v *WorkflowAlert) pulumi.IntOutput { return v.RepeatConditionNumberOfRepeats }).(pulumi.IntOutput)
}
...
func (o WorkflowAlertOutput) SubStatusIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *WorkflowAlert) pulumi.StringArrayOutput { return v.SubStatusIds }).(pulumi.StringArrayOutput)
}
