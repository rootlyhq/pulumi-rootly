...
// ## Import
//
// Using `pulumi import`, import EscalationPolicy using the `id`. For example:
//
// ```sh
...
type EscalationPolicy struct {
	...
	BusinessHours EscalationPolicyBusinessHoursOutput `pulumi:"businessHours"`
...
type escalationPolicyState struct {
	BusinessHours *EscalationPolicyBusinessHours `pulumi:"businessHours"`
	// User who created the escalation policy
...
type EscalationPolicyState struct {
	BusinessHours EscalationPolicyBusinessHoursPtrInput
	// User who created the escalation policy
...
func (o EscalationPolicyOutput) BusinessHours() EscalationPolicyBusinessHoursOutput {
	return o.ApplyT(func(v *EscalationPolicy) EscalationPolicyBusinessHoursOutput { return v.BusinessHours }).(EscalationPolicyBusinessHoursOutput)
}
