...
// ## Import
//
// Using `pulumi import`, import WorkflowPulse using the `id`. For example:
//
// ```sh
...
// The workflow will stop repeating if its runtime since it's first workflow run exceeds the duration set in this field
func (o WorkflowPulseOutput) RepeatConditionDurationSinceFirstRun() pulumi.StringOutput {
	return o.ApplyT(func(v *WorkflowPulse) pulumi.StringOutput { return v.RepeatConditionDurationSinceFirstRun }).(pulumi.StringOutput)
}

// The workflow will stop repeating if the number of repeats exceeds the value set in this field
func (o WorkflowPulseOutput) RepeatConditionNumberOfRepeats() pulumi.IntOutput {
	return o.ApplyT(func(v *WorkflowPulse) pulumi.IntOutput { return v.RepeatConditionNumberOfRepeats }).(pulumi.IntOutput)
}
...
func (o WorkflowPulseOutput) SubStatusIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *WorkflowPulse) pulumi.StringArrayOutput { return v.SubStatusIds }).(pulumi.StringArrayOutput)
}
