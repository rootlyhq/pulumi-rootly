...
type EscalationLevel struct {
	...
	PagingStrategyConfigurationStrategy pulumi.StringPtrOutput `pulumi:"pagingStrategyConfigurationStrategy"`
...
type escalationLevelState struct {
	...
	// Value must be one of `default`, `random`, `cycle`, `alert`.
	PagingStrategyConfigurationStrategy *string `pulumi:"pagingStrategyConfigurationStrategy"`
	// Position of the escalation policy level
...
type EscalationLevelState struct {
	...
	// Value must be one of `default`, `random`, `cycle`, `alert`.
	PagingStrategyConfigurationStrategy pulumi.StringPtrInput
	// Position of the escalation policy level
...
// The ID of the dynamic escalation policy path the level will belong to. If nothing is specified it will add the level to your default path.
func (o EscalationLevelOutput) EscalationPolicyPathId() pulumi.StringOutput {
	return o.ApplyT(func(v *EscalationLevel) pulumi.StringOutput { return v.EscalationPolicyPathId }).(pulumi.StringOutput)
}
...
// Value must be one of `onCallOnly`, `everyone`.
func (o EscalationLevelOutput) PagingStrategyConfigurationScheduleStrategy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *EscalationLevel) pulumi.StringPtrOutput { return v.PagingStrategyConfigurationScheduleStrategy }).(pulumi.StringPtrOutput)
}

// Value must be one of `default`, `random`, `cycle`, `alert`.
func (o EscalationLevelOutput) PagingStrategyConfigurationStrategy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *EscalationLevel) pulumi.StringPtrOutput { return v.PagingStrategyConfigurationStrategy }).(pulumi.StringPtrOutput)
}
