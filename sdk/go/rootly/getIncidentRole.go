...
func LookupIncidentRoleOutput(ctx *pulumi.Context, args LookupIncidentRoleOutputArgs, opts ...pulumi.InvokeOption) LookupIncidentRoleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIncidentRoleResultOutput, error) {
			args := v.(LookupIncidentRoleArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("rootly:index/getIncidentRole:getIncidentRole", args, LookupIncidentRoleResultOutput{}, options).(LookupIncidentRoleResultOutput), nil
