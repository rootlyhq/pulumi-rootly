...
type FormFieldPlacement struct {
	...
	RequiredOperator pulumi.StringPtrOutput `pulumi:"requiredOperator"`
}
...
type formFieldPlacementState struct {
	...
	// Logical operator when evaluating multiple form*field*placement_conditions with conditioned=required. Value must be one of `and`, `or`.
	RequiredOperator *string `pulumi:"requiredOperator"`
}
...
type FormFieldPlacementState struct {
	...
	// Logical operator when evaluating multiple form*field*placement_conditions with conditioned=required. Value must be one of `and`, `or`.
	RequiredOperator pulumi.StringPtrInput
}
...
// Logical operator when evaluating multiple form*field*placement_conditions with conditioned=placement. Value must be one of `and`, `or`.
func (o FormFieldPlacementOutput) PlacementOperator() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FormFieldPlacement) pulumi.StringPtrOutput { return v.PlacementOperator }).(pulumi.StringPtrOutput)
}
...
// Logical operator when evaluating multiple form*field*placement_conditions with conditioned=required. Value must be one of `and`, `or`.
func (o FormFieldPlacementOutput) RequiredOperator() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FormFieldPlacement) pulumi.StringPtrOutput { return v.RequiredOperator }).(pulumi.StringPtrOutput)
}
