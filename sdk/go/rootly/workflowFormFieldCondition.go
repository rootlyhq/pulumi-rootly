...
func (o WorkflowFormFieldConditionOutput) SelectedCatalogEntityIds() pulumi.StringArrayOutput {
...
func (o WorkflowFormFieldConditionOutput) SelectedServiceIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *WorkflowFormFieldCondition) pulumi.StringArrayOutput { return v.SelectedServiceIds }).(pulumi.StringArrayOutput)
}
