...
func GetEnvironments(ctx *pulumi.Context, args *GetEnvironmentsArgs, opts ...pulumi.InvokeOption) (*GetEnvironmentsResult, error) {
	...
	err := ctx.Invoke("rootly:index/getEnvironments:getEnvironments", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o GetEnvironmentsResultOutput) Slug() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetEnvironmentsResult) *string { return v.Slug }).(pulumi.StringPtrOutput)
}
