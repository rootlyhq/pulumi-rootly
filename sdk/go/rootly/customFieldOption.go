...
// ## Import
//
// Using `pulumi import`, import CustomFieldOption using the `id`. For example:
//
// ```sh
// $ pulumi import rootly:index/customFieldOption:CustomFieldOption my-resource 00000000-0000-0000-0000-000000000000
// ```
