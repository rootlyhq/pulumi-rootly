...
func GetTeams(ctx *pulumi.Context, args *GetTeamsArgs, opts ...pulumi.InvokeOption) (*GetTeamsResult, error) {
	...
	err := ctx.Invoke("rootly:index/getTeams:getTeams", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetTeamsOutput(ctx *pulumi.Context, args GetTeamsOutputArgs, opts ...pulumi.InvokeOption) GetTeamsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetTeamsResultOutput, error) {
			...
			return ctx.InvokeOutput("rootly:index/getTeams:getTeams", args, GetTeamsResultOutput{}, options).(GetTeamsResultOutput), nil
...
func (o GetTeamsResultOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetTeamsResult) *string { return v.Name }).(pulumi.StringPtrOutput)
}

func (o GetTeamsResultOutput) Slug() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetTeamsResult) *string { return v.Slug }).(pulumi.StringPtrOutput)
}
