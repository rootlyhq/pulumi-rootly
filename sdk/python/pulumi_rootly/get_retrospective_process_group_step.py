...
def get_retrospective_process_group_step(retrospective_step_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getRetrospectiveProcessGroupStep:getRetrospectiveProcessGroupStep', __args__, opts=opts, typ=GetRetrospectiveProcessGroupStepResult).value

    return AwaitableGetRetrospectiveProcessGroupStepResult(
        id=pulumi.get(__ret__, 'id'),
        retrospective_step_id=pulumi.get(__ret__, 'retrospective_step_id'))
def get_retrospective_process_group_step_output(retrospective_step_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('rootly:index/getRetrospectiveProcessGroupStep:getRetrospectiveProcessGroupStep', __args__, opts=opts, typ=GetRetrospectiveProcessGroupStepResult)
