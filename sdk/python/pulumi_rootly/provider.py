...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] api_host: The Rootly API host. Defaults to https://api.rootly.com
        :param pulumi.Input[str] api_token: The Rootly API Token. Generate it from your account at https://rootly.com/account
        """
