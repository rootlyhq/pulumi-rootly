...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] api_host: The Rootly API host. Defaults to https://api.rootly.com. Can also be sourced from the ROOTLY_API_URL environment
               variable.
        :param pulumi.Input[str] api_token: The Rootly API Token. Generate it from your account at https://rootly.com/account. It must be provided but can also be
