...
def get_environment(color: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getEnvironment:getEnvironment', __args__, opts=opts, typ=GetEnvironmentResult).value
...
def get_environment_output(color: Optional[pulumi.Input[Optional[str]]] = None,
