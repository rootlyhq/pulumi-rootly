...
__all__ = [
    'GetFormFieldPlacementResult',
    'AwaitableGetFormFieldPlacementResult',
    'get_form_field_placement',
    'get_form_field_placement_output',
]

@pulumi.output_type
class GetFormFieldPlacementResult:
    """
...
class AwaitableGetFormFieldPlacementResult(GetFormFieldPlacementResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFormFieldPlacementResult(
            form=self.form,
...
def get_form_field_placement(form: Optional[str] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFormFieldPlacementResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getFormFieldPlacement:getFormFieldPlacement', __args__, opts=opts, typ=GetFormFieldPlacementResult).value

    return AwaitableGetFormFieldPlacementResult(
        form=pulumi.get(__ret__, 'form'),
        form_field_id=pulumi.get(__ret__, 'form_field_id'),
        id=pulumi.get(__ret__, 'id'))


@_utilities.lift_output_func(get_form_field_placement)
def get_form_field_placement_output(form: Optional[pulumi.Input[Optional[str]]] = None,
                                    form_field_id: Optional[pulumi.Input[Optional[str]]] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetFormFieldPlacementResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
