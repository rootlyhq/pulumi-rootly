...
def get_escalation_policy(created_at: Optional[Mapping[str, _builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getEscalationPolicy:getEscalationPolicy', __args__, opts=opts, typ=GetEscalationPolicyResult).value

    return AwaitableGetEscalationPolicyResult(
        created_at=pulumi.get(__ret__, 'created_at'),
        id=pulumi.get(__ret__, 'id'),
        name=pulumi.get(__ret__, 'name'))
def get_escalation_policy_output(created_at: pulumi.Input[Optional[Optional[Mapping[str, _builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('rootly:index/getEscalationPolicy:getEscalationPolicy', __args__, opts=opts, typ=GetEscalationPolicyResult)
