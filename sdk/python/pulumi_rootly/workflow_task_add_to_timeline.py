...
__all__ = ['WorkflowTaskAddToTimelineArgs', 'WorkflowTaskAddToTimeline']

@pulumi.input_type
class WorkflowTaskAddToTimelineArgs:
    def __init__(__self__, *,
                 task_params: pulumi.Input['WorkflowTaskAddToTimelineTaskParamsArgs'],
        ...
        :param pulumi.Input['WorkflowTaskAddToTimelineTaskParamsArgs'] task_params: The parameters for this workflow task.
    ...
    def task_params(self) -> pulumi.Input['WorkflowTaskAddToTimelineTaskParamsArgs']:
        """
    ...
    @task_params.setter
    def task_params(self, value: pulumi.Input['WorkflowTaskAddToTimelineTaskParamsArgs']):
...
@pulumi.input_type
class _WorkflowTaskAddToTimelineState:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 position: Optional[pulumi.Input[int]] = None,
                 skip_on_failure: Optional[pulumi.Input[bool]] = None,
                 task_params: Optional[pulumi.Input['WorkflowTaskAddToTimelineTaskParamsArgs']] = None,
    ...
    @property
    @pulumi.getter(name="taskParams")
    def task_params(self) -> Optional[pulumi.Input['WorkflowTaskAddToTimelineTaskParamsArgs']]:
        """
        The parameters for this workflow task.
        """
        return pulumi.get(self, "task_params")
    ...
    @task_params.setter
    def task_params(self, value: Optional[pulumi.Input['WorkflowTaskAddToTimelineTaskParamsArgs']]):
        pulumi.set(self, "task_params", value)
...
class WorkflowTaskAddToTimeline(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 position: Optional[pulumi.Input[int]] = None,
                 skip_on_failure: Optional[pulumi.Input[bool]] = None,
                 task_params: Optional[pulumi.Input[Union['WorkflowTaskAddToTimelineTaskParamsArgs', 'WorkflowTaskAddToTimelineTaskParamsArgsDict']]] = None,
                 workflow_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[int] position: The position of the workflow task (1 being top of list)
        :param pulumi.Input[bool] skip_on_failure: Skip workflow task if any failures
        :param pulumi.Input[Union['WorkflowTaskAddToTimelineTaskParamsArgs', 'WorkflowTaskAddToTimelineTaskParamsArgsDict']] task_params: The parameters for this workflow task.
        :param pulumi.Input[str] workflow_id: The ID of the parent workflow
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param WorkflowTaskAddToTimelineArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkflowTaskAddToTimelineArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkflowTaskAddToTimelineArgs.__new__(WorkflowTaskAddToTimelineArgs)
        ...
        super(WorkflowTaskAddToTimeline, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            skip_on_failure: Optional[pulumi.Input[bool]] = None,
            task_params: Optional[pulumi.Input[Union['WorkflowTaskAddToTimelineTaskParamsArgs', 'WorkflowTaskAddToTimelineTaskParamsArgsDict']]] = None,
            workflow_id: Optional[pulumi.Input[str]] = None) -> 'WorkflowTaskAddToTimeline':
        """
        ...
        __props__ = _WorkflowTaskAddToTimelineState.__new__(_WorkflowTaskAddToTimelineState)
        ...
        __props__.__dict__["task_params"] = task_params
        __props__.__dict__["workflow_id"] = workflow_id
        return WorkflowTaskAddToTimeline(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="taskParams")
    def task_params(self) -> pulumi.Output['outputs.WorkflowTaskAddToTimelineTaskParams']:
        """
        The parameters for this workflow task.
        """
        return pulumi.get(self, "task_params")
