...
__all__ = ['WorkflowTaskAutoAssignRoleVictorOpsArgs', 'WorkflowTaskAutoAssignRoleVictorOps']

@pulumi.input_type
class WorkflowTaskAutoAssignRoleVictorOpsArgs:
    def __init__(__self__, *,
                 task_params: pulumi.Input['WorkflowTaskAutoAssignRoleVictorOpsTaskParamsArgs'],
        ...
        :param pulumi.Input['WorkflowTaskAutoAssignRoleVictorOpsTaskParamsArgs'] task_params: The parameters for this workflow task.
    ...
    def task_params(self) -> pulumi.Input['WorkflowTaskAutoAssignRoleVictorOpsTaskParamsArgs']:
        """
    ...
    @task_params.setter
    def task_params(self, value: pulumi.Input['WorkflowTaskAutoAssignRoleVictorOpsTaskParamsArgs']):
...
@pulumi.input_type
class _WorkflowTaskAutoAssignRoleVictorOpsState:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 position: Optional[pulumi.Input[int]] = None,
                 skip_on_failure: Optional[pulumi.Input[bool]] = None,
                 task_params: Optional[pulumi.Input['WorkflowTaskAutoAssignRoleVictorOpsTaskParamsArgs']] = None,
    ...
    @property
    @pulumi.getter(name="taskParams")
    def task_params(self) -> Optional[pulumi.Input['WorkflowTaskAutoAssignRoleVictorOpsTaskParamsArgs']]:
        """
        The parameters for this workflow task.
        """
        return pulumi.get(self, "task_params")
    ...
    @task_params.setter
    def task_params(self, value: Optional[pulumi.Input['WorkflowTaskAutoAssignRoleVictorOpsTaskParamsArgs']]):
        pulumi.set(self, "task_params", value)
...
class WorkflowTaskAutoAssignRoleVictorOps(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 position: Optional[pulumi.Input[int]] = None,
                 skip_on_failure: Optional[pulumi.Input[bool]] = None,
                 task_params: Optional[pulumi.Input[Union['WorkflowTaskAutoAssignRoleVictorOpsTaskParamsArgs', 'WorkflowTaskAutoAssignRoleVictorOpsTaskParamsArgsDict']]] = None,
                 workflow_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[int] position: The position of the workflow task (1 being top of list)
        :param pulumi.Input[bool] skip_on_failure: Skip workflow task if any failures
        :param pulumi.Input[Union['WorkflowTaskAutoAssignRoleVictorOpsTaskParamsArgs', 'WorkflowTaskAutoAssignRoleVictorOpsTaskParamsArgsDict']] task_params: The parameters for this workflow task.
        :param pulumi.Input[str] workflow_id: The ID of the parent workflow
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param WorkflowTaskAutoAssignRoleVictorOpsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkflowTaskAutoAssignRoleVictorOpsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkflowTaskAutoAssignRoleVictorOpsArgs.__new__(WorkflowTaskAutoAssignRoleVictorOpsArgs)
        ...
        super(WorkflowTaskAutoAssignRoleVictorOps, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            skip_on_failure: Optional[pulumi.Input[bool]] = None,
            task_params: Optional[pulumi.Input[Union['WorkflowTaskAutoAssignRoleVictorOpsTaskParamsArgs', 'WorkflowTaskAutoAssignRoleVictorOpsTaskParamsArgsDict']]] = None,
            workflow_id: Optional[pulumi.Input[str]] = None) -> 'WorkflowTaskAutoAssignRoleVictorOps':
        """
        ...
        __props__ = _WorkflowTaskAutoAssignRoleVictorOpsState.__new__(_WorkflowTaskAutoAssignRoleVictorOpsState)
        ...
        __props__.__dict__["task_params"] = task_params
        __props__.__dict__["workflow_id"] = workflow_id
        return WorkflowTaskAutoAssignRoleVictorOps(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="taskParams")
    def task_params(self) -> pulumi.Output['outputs.WorkflowTaskAutoAssignRoleVictorOpsTaskParams']:
        """
        The parameters for this workflow task.
        """
        return pulumi.get(self, "task_params")
