...
__all__ = ['WorkflowTaskUpdateStatusArgs', 'WorkflowTaskUpdateStatus']

@pulumi.input_type
class WorkflowTaskUpdateStatusArgs:
    def __init__(__self__, *,
                 task_params: pulumi.Input['WorkflowTaskUpdateStatusTaskParamsArgs'],
        ...
        :param pulumi.Input['WorkflowTaskUpdateStatusTaskParamsArgs'] task_params: The parameters for this workflow task.
    ...
    def task_params(self) -> pulumi.Input['WorkflowTaskUpdateStatusTaskParamsArgs']:
        """
    ...
    @task_params.setter
    def task_params(self, value: pulumi.Input['WorkflowTaskUpdateStatusTaskParamsArgs']):
...
@pulumi.input_type
class _WorkflowTaskUpdateStatusState:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 position: Optional[pulumi.Input[int]] = None,
                 skip_on_failure: Optional[pulumi.Input[bool]] = None,
                 task_params: Optional[pulumi.Input['WorkflowTaskUpdateStatusTaskParamsArgs']] = None,
    ...
    @property
    @pulumi.getter(name="taskParams")
    def task_params(self) -> Optional[pulumi.Input['WorkflowTaskUpdateStatusTaskParamsArgs']]:
        """
        The parameters for this workflow task.
        """
        return pulumi.get(self, "task_params")
    ...
    @task_params.setter
    def task_params(self, value: Optional[pulumi.Input['WorkflowTaskUpdateStatusTaskParamsArgs']]):
        pulumi.set(self, "task_params", value)
...
class WorkflowTaskUpdateStatus(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 position: Optional[pulumi.Input[int]] = None,
                 skip_on_failure: Optional[pulumi.Input[bool]] = None,
                 task_params: Optional[pulumi.Input[Union['WorkflowTaskUpdateStatusTaskParamsArgs', 'WorkflowTaskUpdateStatusTaskParamsArgsDict']]] = None,
                 workflow_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[int] position: The position of the workflow task (1 being top of list)
        :param pulumi.Input[bool] skip_on_failure: Skip workflow task if any failures
        :param pulumi.Input[Union['WorkflowTaskUpdateStatusTaskParamsArgs', 'WorkflowTaskUpdateStatusTaskParamsArgsDict']] task_params: The parameters for this workflow task.
        :param pulumi.Input[str] workflow_id: The ID of the parent workflow
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param WorkflowTaskUpdateStatusArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkflowTaskUpdateStatusArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkflowTaskUpdateStatusArgs.__new__(WorkflowTaskUpdateStatusArgs)
        ...
        super(WorkflowTaskUpdateStatus, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            skip_on_failure: Optional[pulumi.Input[bool]] = None,
            task_params: Optional[pulumi.Input[Union['WorkflowTaskUpdateStatusTaskParamsArgs', 'WorkflowTaskUpdateStatusTaskParamsArgsDict']]] = None,
            workflow_id: Optional[pulumi.Input[str]] = None) -> 'WorkflowTaskUpdateStatus':
        """
        ...
        __props__ = _WorkflowTaskUpdateStatusState.__new__(_WorkflowTaskUpdateStatusState)
        ...
        __props__.__dict__["task_params"] = task_params
        __props__.__dict__["workflow_id"] = workflow_id
        return WorkflowTaskUpdateStatus(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="taskParams")
    def task_params(self) -> pulumi.Output['outputs.WorkflowTaskUpdateStatusTaskParams']:
        """
        The parameters for this workflow task.
        """
        return pulumi.get(self, "task_params")
