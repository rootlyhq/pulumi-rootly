...
class GetIncidentTypeResult:
    ...
    """
    def __init__(__self__, color=None, created_at=None, id=None, name=None, slug=None):
...
def get_incident_type(color: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getIncidentType:getIncidentType', __args__, opts=opts, typ=GetIncidentTypeResult).value
...
@_utilities.lift_output_func(get_incident_type)
def get_incident_type_output(color: Optional[pulumi.Input[Optional[str]]] = None,
                             created_at: Optional[pulumi.Input[Optional[Mapping[str, str]]]] = None,
                             name: Optional[pulumi.Input[Optional[str]]] = None,
                             slug: Optional[pulumi.Input[Optional[str]]] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIncidentTypeResult]:
    """
    ## Example Usage
