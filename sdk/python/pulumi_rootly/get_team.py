...
def get_team(color: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getTeam:getTeam', __args__, opts=opts, typ=GetTeamResult).value
...
def get_team_output(color: Optional[pulumi.Input[Optional[str]]] = None,
