...
class AlertGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] group_by_alert_title: Whether the alerts are grouped by title or not. Value must be one of true or false
        :param pulumi.Input[_builtins.bool] group_by_alert_urgency: Whether the alerts are grouped by urgency or not. Value must be one of true or false
        ...
        :param pulumi.Input[_builtins.int] time_window: Time window for the alert grouping
        """
...
class AlertGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            slug: pulumi.Input[Optional[_builtins.str]] = None,
            targets: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AlertGroupTargetArgs', 'AlertGroupTargetArgsDict']]]]] = None,
            time_window: pulumi.Input[Optional[_builtins.int]] = None) -> 'AlertGroup':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def attributes(self) -> pulumi.Output[Sequence['outputs.AlertGroupAttribute']]:
        return pulumi.get(self, "attributes")
    ...
    @_builtins.property
    @pulumi.getter
    def targets(self) -> pulumi.Output[Sequence['outputs.AlertGroupTarget']]:
        return pulumi.get(self, "targets")
