...
__all__ = ['RetrospectiveProcessGroupStepArgs', 'RetrospectiveProcessGroupStep']
...
class RetrospectiveProcessGroupStepArgs:
    ...
    def retrospective_step_id(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "retrospective_step_id")

    @retrospective_step_id.setter
    def retrospective_step_id(self, value: pulumi.Input[_builtins.str]):
...
@pulumi.type_token("rootly:index/retrospectiveProcessGroupStep:RetrospectiveProcessGroupStep")
class RetrospectiveProcessGroupStep(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param RetrospectiveProcessGroupStepArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RetrospectiveProcessGroupStepArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if retrospective_step_id is None and not opts.urn:
                raise TypeError("Missing required property 'retrospective_step_id'")
            __props__.__dict__["retrospective_step_id"] = retrospective_step_id
        super(RetrospectiveProcessGroupStep, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _RetrospectiveProcessGroupStepState.__new__(_RetrospectiveProcessGroupStepState)

        __props__.__dict__["position"] = position
        __props__.__dict__["retrospective_process_group_id"] = retrospective_process_group_id
        __props__.__dict__["retrospective_step_id"] = retrospective_step_id
        return RetrospectiveProcessGroupStep(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="retrospectiveProcessGroupId")
    def retrospective_process_group_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "retrospective_process_group_id")
