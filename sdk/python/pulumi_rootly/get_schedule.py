...
def get_schedule(created_at: Optional[Mapping[str, _builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getSchedule:getSchedule', __args__, opts=opts, typ=GetScheduleResult).value
...
def get_schedule_output(created_at: pulumi.Input[Optional[Optional[Mapping[str, _builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('rootly:index/getSchedule:getSchedule', __args__, opts=opts, typ=GetScheduleResult)
