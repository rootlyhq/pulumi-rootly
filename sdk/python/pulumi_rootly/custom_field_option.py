...
class CustomFieldOptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] value: The value of the custom*field*option
        :param pulumi.Input[str] color: The hex color of the custom*field*option
        :param pulumi.Input[int] custom_field_id: The ID of the parent custom field
        :param pulumi.Input[int] position: The position of the custom*field*option
        """
