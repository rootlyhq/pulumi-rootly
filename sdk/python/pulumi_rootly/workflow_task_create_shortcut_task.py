...
__all__ = ['WorkflowTaskCreateShortcutTaskArgs', 'WorkflowTaskCreateShortcutTask']

@pulumi.input_type
class WorkflowTaskCreateShortcutTaskArgs:
    def __init__(__self__, *,
                 task_params: pulumi.Input['WorkflowTaskCreateShortcutTaskTaskParamsArgs'],
        ...
        :param pulumi.Input['WorkflowTaskCreateShortcutTaskTaskParamsArgs'] task_params: The parameters for this workflow task.
    ...
    def task_params(self) -> pulumi.Input['WorkflowTaskCreateShortcutTaskTaskParamsArgs']:
        """
    ...
    @task_params.setter
    def task_params(self, value: pulumi.Input['WorkflowTaskCreateShortcutTaskTaskParamsArgs']):
...
@pulumi.input_type
class _WorkflowTaskCreateShortcutTaskState:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 position: Optional[pulumi.Input[int]] = None,
                 skip_on_failure: Optional[pulumi.Input[bool]] = None,
                 task_params: Optional[pulumi.Input['WorkflowTaskCreateShortcutTaskTaskParamsArgs']] = None,
    ...
    @property
    @pulumi.getter(name="taskParams")
    def task_params(self) -> Optional[pulumi.Input['WorkflowTaskCreateShortcutTaskTaskParamsArgs']]:
        """
        The parameters for this workflow task.
        """
        return pulumi.get(self, "task_params")
    ...
    @task_params.setter
    def task_params(self, value: Optional[pulumi.Input['WorkflowTaskCreateShortcutTaskTaskParamsArgs']]):
        pulumi.set(self, "task_params", value)
...
class WorkflowTaskCreateShortcutTask(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 position: Optional[pulumi.Input[int]] = None,
                 skip_on_failure: Optional[pulumi.Input[bool]] = None,
                 task_params: Optional[pulumi.Input[Union['WorkflowTaskCreateShortcutTaskTaskParamsArgs', 'WorkflowTaskCreateShortcutTaskTaskParamsArgsDict']]] = None,
                 workflow_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[int] position: The position of the workflow task (1 being top of list)
        :param pulumi.Input[bool] skip_on_failure: Skip workflow task if any failures
        :param pulumi.Input[Union['WorkflowTaskCreateShortcutTaskTaskParamsArgs', 'WorkflowTaskCreateShortcutTaskTaskParamsArgsDict']] task_params: The parameters for this workflow task.
        :param pulumi.Input[str] workflow_id: The ID of the parent workflow
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param WorkflowTaskCreateShortcutTaskArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkflowTaskCreateShortcutTaskArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkflowTaskCreateShortcutTaskArgs.__new__(WorkflowTaskCreateShortcutTaskArgs)
        ...
        super(WorkflowTaskCreateShortcutTask, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            skip_on_failure: Optional[pulumi.Input[bool]] = None,
            task_params: Optional[pulumi.Input[Union['WorkflowTaskCreateShortcutTaskTaskParamsArgs', 'WorkflowTaskCreateShortcutTaskTaskParamsArgsDict']]] = None,
            workflow_id: Optional[pulumi.Input[str]] = None) -> 'WorkflowTaskCreateShortcutTask':
        """
        ...
        __props__ = _WorkflowTaskCreateShortcutTaskState.__new__(_WorkflowTaskCreateShortcutTaskState)
        ...
        __props__.__dict__["task_params"] = task_params
        __props__.__dict__["workflow_id"] = workflow_id
        return WorkflowTaskCreateShortcutTask(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="taskParams")
    def task_params(self) -> pulumi.Output['outputs.WorkflowTaskCreateShortcutTaskTaskParams']:
        """
        The parameters for this workflow task.
        """
        return pulumi.get(self, "task_params")
