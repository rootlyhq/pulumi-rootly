...
class WorkflowFormFieldConditionArgs:
    def __init__(__self__, *,
                 ...
                 selected_option_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 selected_user_ids: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
                 values: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 workflow_id: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a WorkflowFormFieldCondition resource.
        :param pulumi.Input[str] form_field_id: The custom field for this condition
        ...
        :param pulumi.Input[str] workflow_id: The workflow for this condition
        """
    ...
    def selected_option_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        return pulumi.get(self, "selected_option_ids")

    @selected_option_ids.setter
    def selected_option_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "selected_option_ids", value)

    @property
    @pulumi.getter(name="selectedUserIds")
    def selected_user_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[int]]]]:
        return pulumi.get(self, "selected_user_ids")

    @selected_user_ids.setter
    def selected_user_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]]):
...
class WorkflowFormFieldCondition(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            selected_user_ids: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
            values: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            workflow_id: Optional[pulumi.Input[str]] = None) -> 'WorkflowFormFieldCondition':
        """
    ...
    @property
    @pulumi.getter(name="selectedOptionIds")
    def selected_option_ids(self) -> pulumi.Output[Sequence[str]]:
        return pulumi.get(self, "selected_option_ids")

    @property
    @pulumi.getter(name="selectedUserIds")
    def selected_user_ids(self) -> pulumi.Output[Sequence[int]]:
        return pulumi.get(self, "selected_user_ids")
