...
def get_workflow(created_at: Optional[Mapping[str, str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getWorkflow:getWorkflow', __args__, opts=opts, typ=GetWorkflowResult).value
...
def get_workflow_output(created_at: Optional[pulumi.Input[Optional[Mapping[str, str]]]] = None,
