...
def get_incident_sub_status(assigned_at: Optional[Mapping[str, _builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getIncidentSubStatus:getIncidentSubStatus', __args__, opts=opts, typ=GetIncidentSubStatusResult).value
...
def get_incident_sub_status_output(assigned_at: pulumi.Input[Optional[Optional[Mapping[str, _builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('rootly:index/getIncidentSubStatus:getIncidentSubStatus', __args__, opts=opts, typ=GetIncidentSubStatusResult)
