...
__all__ = ['WorkflowTaskCreateIncidentPostmortemArgs', 'WorkflowTaskCreateIncidentPostmortem']

@pulumi.input_type
class WorkflowTaskCreateIncidentPostmortemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['WorkflowTaskCreateIncidentPostmortemTaskParamsArgs'] task_params: The parameters for this workflow task.
    ...
    def task_params(self) -> pulumi.Input['WorkflowTaskCreateIncidentPostmortemTaskParamsArgs']:
        """
    ...
    @task_params.setter
    def task_params(self, value: pulumi.Input['WorkflowTaskCreateIncidentPostmortemTaskParamsArgs']):
...
class WorkflowTaskCreateIncidentPostmortem(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        :param pulumi.Input[int] position: The position of the workflow task (1 being top of list)
        :param pulumi.Input[bool] skip_on_failure: Skip workflow task if any failures
        :param pulumi.Input[Union['WorkflowTaskCreateIncidentPostmortemTaskParamsArgs', 'WorkflowTaskCreateIncidentPostmortemTaskParamsArgsDict']] task_params: The parameters for this workflow task.
        :param pulumi.Input[str] workflow_id: The ID of the parent workflow
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param WorkflowTaskCreateIncidentPostmortemArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkflowTaskCreateIncidentPostmortemArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkflowTaskCreateIncidentPostmortemArgs.__new__(WorkflowTaskCreateIncidentPostmortemArgs)
        ...
        super(WorkflowTaskCreateIncidentPostmortem, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            skip_on_failure: Optional[pulumi.Input[bool]] = None,
            task_params: Optional[pulumi.Input[Union['WorkflowTaskCreateIncidentPostmortemTaskParamsArgs', 'WorkflowTaskCreateIncidentPostmortemTaskParamsArgsDict']]] = None,
            workflow_id: Optional[pulumi.Input[str]] = None) -> 'WorkflowTaskCreateIncidentPostmortem':
        """
        ...
        __props__ = _WorkflowTaskCreateIncidentPostmortemState.__new__(_WorkflowTaskCreateIncidentPostmortemState)
        ...
        __props__.__dict__["task_params"] = task_params
        __props__.__dict__["workflow_id"] = workflow_id
        return WorkflowTaskCreateIncidentPostmortem(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="taskParams")
    def task_params(self) -> pulumi.Output['outputs.WorkflowTaskCreateIncidentPostmortemTaskParams']:
        """
        The parameters for this workflow task.
        """
        return pulumi.get(self, "task_params")
