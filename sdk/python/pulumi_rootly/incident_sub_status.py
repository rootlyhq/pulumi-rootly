...
class IncidentSubStatusArgs:
    def __init__(__self__, *,
                 ...
                 assigned_by_user_id: pulumi.Input[Optional[_builtins.int]] = None,
                 incident_id: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a IncidentSubStatus resource.

        :param pulumi.Input[_builtins.str] sub_status_id: Note: To change an incident's sub-status, use the PATCH /incidents/:id endpoint and set the sub*status*id attribute. This endpoint is for modifying the timestamp of when an incident's sub-status was assigned.
        """
    ...
    def assigned_by_user_id(self) -> pulumi.Input[Optional[_builtins.int]]:
        return pulumi.get(self, "assigned_by_user_id")

    @assigned_by_user_id.setter
    def assigned_by_user_id(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class IncidentSubStatus(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="assignedByUserId")
    def assigned_by_user_id(self) -> pulumi.Output[_builtins.int]:
        return pulumi.get(self, "assigned_by_user_id")
